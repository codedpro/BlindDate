    ...
    <>
      {isAgeOpen && (
        <div className="fixed w-full top-0 left-0  h-full bg-black z-[9999] flex items-center justify-center">
          <div className="bg-secondary text-white p-4 rounded-lg flex flex-col items-center space-y-4">
      ...
      <div
        dir="rtl"
        className="flex flex-col min-h-screen bg-secondary text-white relative"
      >
                  ...
                  <div className="dark StepOne_container__lgv_Q w-full">
                    <form>
                      ...
                      <div className="StepOne_infoContainer__iZ8sV StepOne_infoContainerMargin__bygEA my-2 ">
                        <div className="Input_container__e4usK my-2 border border-[#616166] rounded-lg">
                          <input
                            className=" py-[10px] px-[16px] Input_input__MiI_q "
                            placeholder="نام"
                            minLength="1"
                            maxLength="15"
                            value={name}
                        ...
                        <div className="border border-[#616166] rounded-lg">
                          {" "}
                          <input
                      ...
                      <div className="StepOne_infoContainer__iZ8sV mb-10">
                        <div
                          className="relative cursor-pointer  border border-[#616166] rounded-lg"
                          onClick={() => {
                            setIsAgeOpen(true);
                          }}
                        >
                        ...
                        <div
                          className="relative grid justify-between py-2.5 px-4 rounded-m border border-[#616166] rounded-lg  transition-all duration-200 ease-in-out active:bg-active-primary grid-flow-col items-center cursor-pointer "
                      ...
                      <div>
                        ...
                        <div className="StepOne_genderContainer__qkUZM">
                          <label
                            className="Radio_container__tK1Ib StepOne_radio__sBtjy border border-[#616166] rounded-lg"
                            htmlFor="male"
                          >
                            <input
